            ...
            <body>
                <div class='email-container'>
                    ...
                    <div class='email-body'>
                        ...
                        <p>Puedes accesar al siguiente Link: https://lab.lacallecr.com/VV/</p>
                        <p>Tu usuario es tu número de filial: <strong>$userNumber</strong></p>
                        <p>Tu password es: <strong>$password</strong></p>
                        <p>En este link puedes ver un pequeño tutorial <a href='https://drive.google.com/file/d/1MSDACTrnm9_Qw3qSGmSnpToPhn40VayV/view?usp=sharing'>Ver</a></p>
                    </div>
                    <div class='t-container'>
                        <p> <strong>*** OPCIONAL ***</strong></p>
                        <p> Si quieres recibir notificaciones cuando un tema es agregado .</p>
                        <p>Puedes accesar a nuestro Bot de Telegram <img width='25px' src='https://lab.lacallecr.com/VV/utilities/tema/images/telegram.png'> </p>
                        <p> Buscando el bot @CRVV_bot o accediendo desde el teléfono el siguiente Link: https://t.me/CRVV_bot</p> (Necesitas tener Telegram en tu Teléfono)
                        <p> Una vez dentro puedes digitar el comando <strong>$command</strong> (Puedes copiar y pegar este comando)</p>
                        
                        <p>En este link puedes ver un pequeño tutorial <a href='https://drive.google.com/file/d/17xZrVF2DRsNT4Gu8KSYlYg4msq33rkAx/view?usp=sharing'>Ver</a></p>
                    </div>
                    <div class='email-footer'>
                        <img style='width: 120px' src='https://lab.lacallecr.com/VV/apps/Forum/images/Logo_VV.png' alt='Valle Verde' />
                        <p>Saludos,<br>Comité Asesor Condominio Valle Verde</p>
...
$emails[0]['email'] = 'alexis.andrade@gmail.com';
$emails[0]['nombrel'] = 'ALEXIS AAA';
$emails[0]['filial'] = '83';
/*$emails[1]['email'] = 'comiteasesorvalleverde@gmail.com';
$emails[1]['nombrel'] = 'Comité Asesor';
$emails[1]['filial'] = '00';
$emails[2]['email'] = 'aleaz05@gmail.com';
$emails[2]['nombrel'] = 'Alexis Andrade';
$emails[2]['filial'] = '83';*/
