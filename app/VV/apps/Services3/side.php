        ...
        <div class="blocktxt">
            <ul class="cats">
                 <? foreach($categories as $c) { ?>
                    ...
                    ?>
                <li><a href="https://lab.lacallecr.com/VV/apps/Services/index.php?c=<? echo $c->vars['id']?>"><? echo $c->vars['nombre']?><span class="badge pull-right"><? echo $t ?></span></a></li>
                <? } ?>
            </ul>
        </div>
    </div>
...
<div class="sidebarblock">
    ...
    <div class="divline"></div>
    <div class="blocktxt">
          <a href="https://lab.lacallecr.com/VV/apps/Services/topic.php?t=<? echo $t['id']?>"><? echo $t['titulo']?></a>
    </div>
     <? }?> 
     <? } else { ?>
